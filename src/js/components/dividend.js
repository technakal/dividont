 ...
 */
export var calculateDividend = function (auditedPremium, dividendFactor, emodFactor, surchargeTotal) {
    if (surchargeTotal === void 0) { surchargeTotal = 0; }
    ...
    return Math.round(dividendFactor *
 ...
 */
export var getFinalEmodFactor = function (emodFactor) {
    return 1 - emodFactor <= 0.3 && 1 - emodFactor > 0 ? 1 - emodFactor : 0.3;
};
